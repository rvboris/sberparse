...
- Поддерживается один актуальный экстрактор: `SBER_DEBIT_2603`.
...
- `SBER_DEBIT_2603` — дебетовая выписка Сбербанка образца марта 2026.
...
pnpm exec tsx src/cli.ts ./statement.pdf -f SBER_DEBIT_2603 --interm
```
...
- Поддерживаем только актуальный формат выписки, без хранения старых/legacy extractor-ов.
